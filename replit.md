...
- **BrazilStateCitySelector**: Fully controlled reusable component with all 27 Brazilian states and dynamic city loading via IBGE API (all municipalities), used in onboarding and RadarCoracao
